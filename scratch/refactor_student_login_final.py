...
# 1. Update StudentLoginScreen to ask for Name, Matric, and PIN directly
new_student_login = """
...
content = re.sub(
    ...
    new_student_login.strip() + "\n\n  // ─── Landing Screen",
    content,
    flags=re.DOTALL
)

# 2. Add automatic OTP generation BACK to Lecturer "Add Student"
add_student_code = """
                    ...
                    alert(`Student created! Their login password (${otp}) was emailed to them.`);
...
bulk_import_code = """
                    ...
                    if(added.length > 0) {
                      ...
                      alert(`Successfully imported ${added.length} students! Login passwords were automatically emailed to them.`);
