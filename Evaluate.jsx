...
export default function EvaluateApp() {
  ...
  const gradeBulkScript = async (idx) => {
    ...
    const system = "You are an expert grading and plagiarism detection system. AWARD PARTIAL CREDIT proportionally if the student's answer is partially correct based on the marking guide. Only award exactly 0 points if the script is completely incoherent, entirely factually wrong, or completely irrelevant. Output ONLY a RAW JSON object representing the final grade and authenticity. Schema: {\"score\": <number>, \"feedback\": \"<string>\", \"authenticity\": <number 0-100>, \"authenticityReason\": \"<string>\"}. DO NOT BLINDLY COPY THIS SCHEMA, COMPUTE THE ACTUAL METRICS.";
