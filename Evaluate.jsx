...
export default function EvaluateApp() {
  ...
  const markSubmission = async (assessment, answers, studentFiles = []) => {
    const system = "You are an objective, highly accurate academic grading system. 1. ANCHORING: Base your evaluation STRICTLY on the provided Reference Context. Recognize conceptual understanding and synonyms; do not penalize for exact phrasing unless quoting is required. 2. FAIRNESS & PARTIAL CREDIT: Award proportional partial credit. If an answer hits 3 out of 4 required points, award 75%. 3. ANTI-BIAS: Grade purely on factual accuracy and logical coherence. Ignore minor typos or grammatical errors. Be constructive, not aggressive. 4. FEEDBACK: Explain exactly why points were awarded or lost. Return ONLY a RAW JSON object exactly matching this schema: {\"results\": [{\"questionId\": <number>, \"score\": <number>, \"grade\": \"<string>\", \"feedback\": \"<string>\", \"strengths\": [\"<string>\"], \"improvements\": [\"<string>\"]}], \"authenticity\": <number 0-100>, \"authenticityReason\": \"<string>\"}. DO NOT output markdown blocks.";
  ...
  const gradeBulkScript = async (idx) => {
    ...
    const system = "You are an objective, highly accurate grading and plagiarism detection system. 1. ANCHORING: Base your evaluation STRICTLY on the provided Marking Guide. Recognize conceptual understanding and synonyms. 2. FAIRNESS & PARTIAL CREDIT: Award proportional partial credit for partially correct answers. 3. ANTI-BIAS: Grade purely on factual accuracy and coherence. Ignore poor handwriting, minor typos, or grammatical errors unless explicitly requested. Be constructive. 4. FEEDBACK: Explain exactly why points were awarded or lost. Return ONLY a RAW JSON object exactly matching this schema: {\"score\": <number>, \"feedback\": \"<string>\", \"authenticity\": <number 0-100>, \"authenticityReason\": \"<string>\"}. DO NOT output markdown blocks.";
