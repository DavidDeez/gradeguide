...
// ─── Route Auth Screens ───────────────────────────────────────────────────
  if (!role) {
    if (authScreen === 'student-login') return <><GlobalStyles /><ParticleBackground /><div className="blueprint-grid" /><StudentLoginScreen /></>;
    return <><GlobalStyles /><ParticleBackground /><div className="blueprint-grid" /><LoginScreen />{loginModalRole && RoleLoginModal()}</>;
  }

  if (role === 'FacultyHub') {
    return <><GlobalStyles /><ParticleBackground /><div className="blueprint-grid" /><FacultyHubScreen /></>;
  }

  return (
    <>
      <GlobalStyles /><ParticleBackground /><div className="blueprint-grid" />
